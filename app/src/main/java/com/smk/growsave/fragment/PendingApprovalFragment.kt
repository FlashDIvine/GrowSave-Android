...
import com.smk.growsave.databinding.FragmentPendingApprovalBinding
...
class PendingApprovalFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Setup Listener Tombol Refresh
        binding.btnRefreshStatus.setOnClickListener {
            (activity as? com.smk.growsave.MainActivity)?.checkUserStatus(showLoading = true)
        }

        // Setup Listener Tombol Logout
